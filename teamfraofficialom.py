#!/usr/bin/python2
#coding=utf-8
#TECH OMAR THE OFFICAL ROGRAMMER 
#FBCLONING COMMANDZ MAKER TEAMFRAOFFICIAL
#YOUTUBE TECH OM
...
\033[1;91m─────────██████████████─██████─────────██████─────────██████████─██████████████─██████████─██████──██████─██████████████─
\033[1;91m─────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────
	   \033[1;47m \033[1;31m Coder by : Tech-OM \033[1;0m     
\033[0;95m╭════════════════════════════════════════════╮
...
jalan('\033[1;94m──║║║║═╣╔╗║║║║║║──║║║╔╗║║╚═╝║║║─║║║║╚═╣║╔╗║╚╗')
jalan('\033[1;94m──╚╝╚══╩╝╚╩╩╩╝╚╝──╚╝╚╝╚╝╚═══╝╚╝─╚╝╚╩══╩╩╝╚╩═╝')
jalan('\033[1;47m                \033[1;31mTECH-OM                  \033[1;0m     ') 
jalan('⊱⊹⊰━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━⊱⊹⊰') 
...
while (loop == 'true'):
    ...
    if (username == CorrectUsername):
        ...
        if (password == CorrectPassword):
            print "Logged in successfully as " + username  #DEV Tech-OM
            loop = 'false'
        else:
            print "Wrong password!"
            os.system('xdg-open https://m.youtube.com/channel/UCjyFIyzo3YFnPlrmn8XbbTA')
    else:
...
def pilih_login():
	...
	if peak =="":
		...
		os.system('xdg-open https://github.com/nwaz1996')
		login()
	elif unikers =="0":
		jalan('Token Removed')
